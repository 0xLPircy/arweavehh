      ...
      <div className="px-20 flex flex-col gap-[30px] pt-[30px]">
        <div className="flex flex-col">
          <div className="flex flex-row justify-start items-center gap-[12px]">
            <h2 className="text-[45px] text-[#40959D] font-[Rale-Bold]">
              {project.name}
            </h2>
            <div className="rounded-sm px-[12px] flex flex-row items-center font-[Rale-SemiBold] py-[3px] bg-[#393939] h-fit text-[#f1f1f1]">
              ${project.ticker}
            </div>
          </div>
          <div className="text-[#f1f1f1] text-[15px]">
            {project.description}
          </div>
        </div>
        <div className="flex flex-col gap-[18px]">
          <h3 className=" text-[#40959D] text-[33px] font-[Rale-SemiBold]">
            Founders
          </h3>
        ...
        <div className="flex flex-col gap-[18px]">
          <h3 className="text-[33px] text-[#40959D] font-[Rale-SemiBold]">
            Socials
          </h3>
        ...
        <div className="flex flex-col gap-[18px]">
          ...
          <p className="text-[#f1f1f1] text-[15px]">
            ...
            <span className="text-[#40959D]">
              {humanizeDuration(project.cooldownPeriod)}
            </span>
            <br />
            Reward:{" "}
            <span className="text-[#40959D]">
            ...
            <div className="relative w-fit max-w-[450px] bg-[#111111] p-8 rounded-lg ">
              ...
              {step == "1" && (
                <>
                  <button
                    onClick={closeModal}
                    className="absolute top-2 right-2 text-2xl font-bold text-gray-500 hover:text-gray-600"
                  >
                    &times;
                  </button>
                ...
                pl-2"
                  ...
                  <div className="bg-[#1A1A1A] p-4 rounded mb-6 max-w-[100%]">
                    <p className="text-[#8D8D8D] text-[12px]">{`On staking $AOEth you will receive ${
                      amount
                        ? parseFloat(amount) * project.aoethRewardRate
                        : "-"
                    } of $${
                      project.ticker
                    }. There is a cool down period of ${humanizeDuration(
                      project.cooldownPeriod
                    )} for unstaking your $AOEth.`}</p>
                  </div>
                  <button
                    onClick={async () => {
                ...
                <div className="relative">
                  ...
                  <div className="relative z-10 flex flex-col space-y-6">
                    ...
                    <div className="flex items-center">
                      ...
                      >
                        {project.name} confirmed deposit
                      </div>
                    </div>
                    <div className="flex items-center">
                      <div
                      ...
                      >
                        ${project.ticker} reward sent to your wallet
                      </div>
                    </div>
                  </div>
                  <button
                    ...
                    } text-[#f1f1f1] py-[6px] px-[18px] rounded m-4`}
                  >
                    {rewardsSent ? (
                      "See Your Profile"
                    ) : (
