...
const UserProjectCard = ({ projectData, amountStaked, amountReceived }: UserProjectCardProps) => {
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-row gap-[12px]">
        <button onClick={() => unstake(projectData)} className="rounded-md w-[120px] py-[3px] bg-[#40959D]">
          Unstake
        </button>
